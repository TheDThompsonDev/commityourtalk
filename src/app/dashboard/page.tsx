    ...
    <div className="min-h-screen bg-[#F9FAFB]">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-8">
              ...
              <div className="hidden md:flex items-center gap-6">
                <Link href="/dashboard" className="text-[#3685ff] font-semibold">
                  Dashboard
                </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-lg text-gray-600">&quot;The only way to get better at speaking is to do it.&quot;</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Your Progress at a Glance</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  <h3 className="text-base font-semibold text-gray-700 mb-6 text-center">Overall Completion</h3>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  <h3 className="text-base font-semibold text-gray-700 mb-6 text-center">Confidence Growth</h3>
                  <div className="flex items-center justify-center">
                    <div className="relative w-32 h-32">
                      <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                        <circle
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <div className="text-sm text-gray-600 mb-1 font-medium">Completed Talks</div>
                <div className="text-4xl font-bold text-gray-900">4</div>
              </div>
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <div className="text-sm text-gray-600 mb-1 font-medium">Hours Practiced</div>
                <div className="text-4xl font-bold text-gray-900">12</div>
              </div>
              <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                <div className="text-sm text-gray-600 mb-1 font-medium">Skills Unlocked</div>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    <div className="text-sm font-semibold text-[#3685ff] uppercase tracking-wide mb-1">Next Up</div>
                    <h3 className="text-2xl font-bold text-gray-900">Crafting Your Core Message</h3>
                  </div>
                </div>
                <p className="text-gray-600 mb-6">Learn to distill your ideas into a powerful, memorable narrative.</p>
                <Link
                  href="/pathway"
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-[#FFE8EE] rounded-xl flex items-center justify-center">
                      <svg className="w-5 h-5 text-[#FF5F87]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-[#FF5F87] rounded-full" style={{ width: '60%' }}></div>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-10 h-10 bg-[#E8F1FF] rounded-xl flex items-center justify-center">
                      <svg className="w-5 h-5 text-[#3685ff]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-[#3685ff] rounded-full" style={{ width: '0%' }}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
                  <div className="flex gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-sm font-bold text-[#FF5F87] uppercase">Oct</div>
                      <div className="text-3xl font-bold text-gray-900">28</div>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 mb-1">Practice Pitch</h3>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm opacity-75">
                  <div className="flex gap-4 mb-4">
                    <div className="text-center">
                      <div className="text-sm font-bold text-gray-500 uppercase">Nov</div>
                      <div className="text-3xl font-bold text-gray-900">04</div>
                    </div>
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 mb-1">Peer Feedback Round</h3>
                ...
                <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm opacity-75">
                  <div className="flex gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-gray-900 mb-1">Mentor Review: Storytelling</h3>
