...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      animateValue(0, 85, 2000, (value) => setAnimatedStats(prev => ({ ...prev, confidence: value })));
      animateValue(0, 1200, 2500, (value) => setAnimatedStats(prev => ({ ...prev, talks: value })));
      animateValue(0, 500, 2000, (value) => setAnimatedStats(prev => ({ ...prev, members: value })));
    }, 1000);
  ...
  return (
    <MainLayout>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            <div className="transition-all duration-1000 opacity-100 translate-y-0 text-center lg:text-left">
              ...
              <div className="inline-flex items-center px-3 sm:px-4 py-2 bg-white/10 border border-white/20 rounded-full mb-4 sm:mb-6 text-xs sm:text-sm font-semibold text-blue-200">
                ...
                <span className="hidden sm:inline">Join {animatedStats.members}+ developers building confidence</span>
                <span className="sm:hidden">{animatedStats.members}+ developers</span>
              </div>
              ...
              <p className="text-base sm:text-lg md:text-xl text-slate-200 mt-4 sm:mt-6 max-w-2xl mx-auto lg:mx-0">
                Join weekly Discord sessions designed for developers. Go from 2-minute talks to conference keynotes through structured practice and peer feedback.
              </p>
              ...
              {/* Friction reducer */}
              <p className="text-xs sm:text-sm text-slate-400 mt-3 sm:mt-4">No credit card • Join Discord • Start this week</p>
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 sm:gap-6 text-xs sm:text-sm mt-6 sm:mt-8">
                <div className="flex items-center gap-2 sm:gap-3 group">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-green-500/20 rounded-full flex items-center justify-center border border-green-400/30">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-300" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="font-semibold text-slate-200">Free forever</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 group">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-500/20 rounded-full flex items-center justify-center border border-blue-400/30">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-300" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="font-semibold text-slate-200">1 session/week</span>
                </div>
                <div className="flex items-center gap-2 sm:gap-3 group">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-pink-500/20 rounded-full flex items-center justify-center border border-pink-400/30">
                    <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-pink-200" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 9a3.001 3.001 0 01-2 2.83V11a1 1 0 102 0v-1a1 1 0 111 1 1 1 0 001-1zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
                    </svg>
                  </div>
                  <span className="font-semibold text-slate-200 hidden sm:inline">No experience needed</span>
                  <span className="font-semibold text-slate-200 sm:hidden">No experience</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative bg-white/5 rounded-2xl p-4 sm:p-6 lg:p-8 shadow-xl border border-white/10">
                ...
                <div className="flex items-center gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-white/10 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="font-semibold text-white text-base sm:text-lg truncate">Alex Martinez</div>
                    <div className="text-xs sm:text-sm text-slate-300 flex items-center gap-2">
                      <span className="hidden sm:inline">Presenting:</span>
                      <span className="font-semibold text-blue-300 truncate">&quot;Why TypeScript Matters&quot;</span>
                    </div>
                    <div className="flex items-center gap-2 mt-1">
                      <div className="w-2 h-2 bg-red-500 rounded-full"></div>
                      <span className="text-xs text-slate-400">Recording • 8 watching</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 border border-white/10">
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <span className="text-xs sm:text-sm font-semibold text-white">Live Audience</span>
                  ...
                  <div className="flex -space-x-2 mb-3 sm:mb-4 overflow-x-auto">
                    {[...Array(8)].map((_, i) => (
                      <div key={i} className="relative">
                        <div className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full border-2 border-slate-800 shadow-sm transition-all duration-300 ${
                          i < 3 ? 'bg-blue-600' :
                          i < 6 ? 'bg-pink-600' :
                          'bg-green-600'
                        }`}></div>
                        {i < 2 && (<div className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 w-3 h-3 sm:w-4 sm:h-4 bg-green-500 rounded-full border border-slate-800"></div>)}
                      </div>
                    ))}
                  </div>
                  <div className="grid grid-cols-2 gap-2 sm:gap-3">
                    <button className="bg-green-600 hover:bg-green-700 text-white font-semibold py-2 sm:py-3 px-2 sm:px-4 rounded-lg sm:rounded-xl text-xs sm:text-sm shadow-lg transition-colors group">
                      <span className="flex items-center justify-center gap-1 sm:gap-2">
                        👏 <span className="hidden sm:inline group-hover:animate-bounce">Great Point!</span>
                    ...
                    <button className="bg-transparent hover:bg-white/10 text-white font-semibold py-2 sm:py-3 px-2 sm:px-4 rounded-lg sm:rounded-xl text-xs sm:text-sm border border-white/20 transition-colors group">
                      <span className="flex items-center justify-center gap-1 sm:gap-2">
                        ❓ <span className="hidden sm:inline group-hover:animate-pulse">Ask Question</span>
                ...
                <div className="mt-4 sm:mt-6 flex flex-wrap gap-2">
                  <span className="px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm bg-white/10 text-white border border-white/20">60 min</span>
                  <span className="px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm bg-white/10 text-white border border-white/20">Small groups</span>
                  <span className="px-2.5 sm:px-3 py-1 rounded-full text-xs sm:text-sm bg-white/10 text-white border border-white/20">Discord</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4 mt-6 sm:mt-8">
                <div className="bg-white/5 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xl border border-white/10 group">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2">
                    ...
                    <div>
                      <div className="text-xl sm:text-2xl font-extrabold text-white">{animatedStats.confidence}%</div>
                      <div className="text-xs text-slate-300 font-medium">Confidence</div>
                    </div>
                  </div>
                  <div className="w-full bg-white/10 rounded-full h-1.5 sm:h-2">
                    <div className="bg-blue-500 h-1.5 sm:h-2 rounded-full transition-all duration-1000 ease-out" style={{width: `${animatedStats.confidence}%`}}></div>
                  </div>
                </div>
                ...
                <div className="bg-white/5 rounded-xl sm:rounded-2xl p-4 sm:p-5 shadow-xl border border-white/10 group">
                  <div className="flex items-center gap-2 sm:gap-3 mb-2">
                    ...
                    <div>
                      <div className="text-xl sm:text-2xl font-extrabold text-white">{animatedStats.talks}+</div>
                      <div className="text-xs text-slate-300 font-medium">Talks</div>
                    </div>
                  </div>
                  <div className="flex -space-x-1">
                    {[...Array(5)].map((_, i) => (
                      <div key={i} className="w-3 h-3 sm:w-4 sm:h-4 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full border border-white animate-pulse" style={{animationDelay: `${i * 200}ms`}}></div>
                    ))}
                  </div>
                </div>
              </div>
      ...
      {/* Quick Wins Section - Immediate value */}
      <section className="bg-slate-50 py-12 sm:py-16 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">What you&apos;ll gain</h2>
            <p className="text-base sm:text-lg text-gray-600">Build skills that transform your career</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white rounded-lg p-6 text-center border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Organize thoughts quickly under pressure</p>
            </div>
            <div className="bg-white rounded-lg p-6 text-center border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Structure ideas that resonate with audiences</p>
            </div>
            <div className="bg-white rounded-lg p-6 text-center border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Present to any audience without fear</p>
            </div>
            <div className="bg-white rounded-lg p-6 text-center border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Lead meetings and influence decisions</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 animate-fade-in">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed animate-fade-in delay-300 px-4">
              Track real journeys from first nervous talk to career-changing presentations
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow animate-fade-in delay-400">
              ...
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Junior Dev → Tech Lead</div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between text-sm mb-3">
                  <span className="font-semibold text-gray-700">6-month journey</span>
                  <span className="text-blue-600 font-bold">Level 3 ✓</span>
                </div>
                <div className="relative">
                  <div className="absolute top-2 left-2 right-2 h-0.5 bg-gray-200"></div>
                  <div className="absolute top-2 left-2 h-0.5 bg-blue-600" style={{width: '60%'}}></div>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <div className="text-xs font-bold text-red-600 uppercase mb-1">Before</div>
                  <p className="text-sm text-gray-600">Terrified of standup meetings</p>
                </div>
                <svg className="w-6 h-6 text-blue-600 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                </svg>
                <div>
                  <div className="text-xs font-bold text-green-600 uppercase mb-1">After</div>
                  <p className="text-sm text-gray-600">Leading company all-hands presentations</p>
                </div>
              </div>

              {/* Outcome */}
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                <div className="text-xs font-bold text-green-700 uppercase mb-2">Career Impact</div>
                <p className="text-sm text-gray-700 font-semibold">Promoted to Tech Lead</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow animate-fade-in delay-600">
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between text-sm mb-3">
                  <span className="font-semibold text-gray-700">10-month journey</span>
                  <span className="text-pink-600 font-bold">Level 4 ✓</span>
                </div>
                <div className="relative">
                  <div className="absolute top-2 left-2 right-2 h-0.5 bg-gray-200"></div>
                  <div className="absolute top-2 left-2 h-0.5 bg-pink-600" style={{width: '80%'}}></div>
                  <div className="relative flex justify-between">
                    <div className="flex flex-col items-center">
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <div className="text-xs font-bold text-red-600 uppercase mb-1">Before</div>
                  <p className="text-sm text-gray-600">Avoided speaking as an introvert</p>
                </div>
                <svg className="w-6 h-6 text-pink-600 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" />
                </svg>
                <div>
                  <div className="text-xs font-bold text-green-600 uppercase mb-1">After</div>
                  <p className="text-sm text-gray-600">Delivered 3 conference talks</p>
                </div>
              </div>

              {/* Outcome */}
              <div className="bg-pink-50 rounded-lg p-4 border border-pink-200">
                <div className="text-xs font-bold text-pink-700 uppercase mb-2">Achievement</div>
                <p className="text-sm text-gray-700 font-semibold">12 talks • 3 conferences</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200 shadow-sm hover:shadow-md transition-shadow animate-fade-in delay-800">
              ...
              <div className="bg-slate-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-between text-sm mb-3">
                  <span className="font-semibold text-gray-700">4-month journey</span>
                  <span className="text-green-600 font-bold">Level 2 ✓</span>
                </div>
                <div className="relative">
                  <div className="absolute top-2 left-2 right-2 h-0.5 bg-gray-200"></div>
                  <div className="absolute top-2 left-2 h-0.5 bg-green-600" style={{width: '40%'}}></div>
                  <div className="relative flex justify-between">
                    <div className="flex flex-col items-center">
              ...
              <div className="space-y-4 mb-6">
                <div>
                  <div className="text-xs font-bold text-red-600 uppercase mb-1">Before</div>
                  <p className="text-sm text-gray-600">Struggled with team communication</p>
                </div>
                ...
                <div>
                  <div className="text-xs font-bold text-green-600 uppercase mb-1">After</div>
                  <p className="text-sm text-gray-600">Manager praised communication in review</p>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                <div className="text-xs font-bold text-green-700 uppercase mb-2">Career Impact</div>
                <p className="text-sm text-gray-700 font-semibold">Landed promotion</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-12 sm:mb-16 animate-fade-in delay-1000">
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              These are just three of hundreds of success stories. Your journey starts with one session.
            </p>
          </div>
          ...
          <div className="text-center animate-fade-in delay-1100">
            <div className="inline-flex flex-col sm:flex-row items-center gap-8 sm:gap-12 bg-white/90 backdrop-blur-sm rounded-3xl px-8 sm:px-12 py-6 sm:py-8 shadow-2xl border border-gray-200/50">
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Active Members</div>
              ...
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Talks Delivered</div>
              ...
              <div className="text-center group hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-xs sm:text-sm text-gray-600 font-semibold uppercase tracking-wide">Confidence Boost</div>
      ...
      {/* Outcomes Row - Enhanced */}
      <section className="bg-gradient-to-b from-white to-slate-50 py-12 sm:py-16 lg:py-20 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3">What you&apos;ll achieve</h2>
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto px-4">Four key outcomes that transform how you communicate and lead</p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { 
              ...
              <div key={i} className="group relative bg-white rounded-2xl p-6 border border-gray-200 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-start gap-4 mb-4">
                  <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                    o.color === 'blue' ? 'bg-blue-100 text-blue-600' :
                    o.color === 'green' ? 'bg-green-100 text-green-600' :
                    o.color === 'purple' ? 'bg-purple-100 text-purple-600' :
                    'bg-pink-100 text-pink-600'
                  }`}>
                    {o.icon}
                  </div>
                  <div className={`text-xs font-bold px-2 py-1 rounded-full ${
                    o.color === 'blue' ? 'bg-blue-50 text-blue-700' :
                    o.color === 'green' ? 'bg-green-50 text-green-700' :
                    o.color === 'purple' ? 'bg-purple-50 text-purple-700' :
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 mb-3 sm:mb-4 px-4">
              Your roadmap to
              <span className="block bg-gradient-to-r from-blue-600 via-purple-600 to-pink-500 bg-clip-text text-transparent mt-2">conference speaking</span>
            </h2>
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">
              Progress through 5 structured levels—from your first 2-minute talk to 45-minute keynotes
            </p>
          </div>

          {/* Visual Pathway Preview - Enhanced */}
          <div className="max-w-5xl mx-auto mb-10 sm:mb-16">
            <div className="relative py-8 sm:py-12">
              {/* Pathway Line - Hidden on mobile */}
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 sm:gap-2">
                {[
                  { level: 1, title: "Icebreaker", color: "#3b82f6", bgColor: "bg-blue-600", description: "2-min talks" },
                  { level: 2, title: "Storyteller", color: "#a855f7", bgColor: "bg-purple-600", description: "5-min talks" },
                  { level: 3, title: "Presenter", color: "#ec4899", bgColor: "bg-pink-600", description: "10-min talks" },
                  { level: 4, title: "Speaker", color: "#10b981", bgColor: "bg-green-600", description: "20-min talks" },
                  { level: 5, title: "Keynote", color: "#f59e0b", bgColor: "bg-yellow-500", description: "45-min talks" }
                ].map((item) => (
                  <div key={item.level} className="flex flex-col items-center">
                    <div className={`relative w-16 h-16 sm:w-20 sm:h-20 rounded-full ${item.bgColor} shadow-xl border-4 border-white mb-3 sm:mb-4 flex items-center justify-center transform hover:scale-110 transition-transform duration-300 z-10`}>
                      <span className="text-white font-bold text-xl sm:text-2xl">{item.level}</span>
                    </div>
                    <div className="text-center px-1 sm:px-2">
                      <div className="font-bold text-gray-900 text-sm sm:text-base mb-1">{item.title}</div>
          ...
          <div className="text-center">
            ...
            <p className="mt-4 text-gray-600 text-sm">Explore all 5 levels with detailed session guides</p>
          </div>
        </div>
      </section>

      <section className="relative py-12 sm:py-16 lg:py-24 bg-white overflow-hidden" id="how-it-works">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-4">A clear progression through five levels of speaking mastery</p>
          </div>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 sm:p-8 lg:p-10 max-w-3xl mx-auto border border-blue-100 shadow-lg">
              <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">Ready to start practicing?</h3>
              <p className="text-base sm:text-lg text-gray-600 mb-6 sm:mb-8 px-4">Join a free session this week. No experience or preparation needed.</p>
              <Link
                href="/signin"
              ...
              >
                ...
                <svg className="w-5 h-5 sm:w-6 sm:h-6 ml-2 group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
                </svg>
              </Link>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-20 animate-fade-in">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black text-gray-900 mb-4 sm:mb-6 animate-fade-in delay-200 px-4">
              A <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">safe space</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-md transition-transform duration-300 hover:-translate-y-1 animate-fade-in delay-400">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Small, intimate groups</h3>
              <p className="text-gray-600 text-lg leading-relaxed text-center">
                Practice with just 5-10 supportive developers. No massive audiences. No judgment.
              </p>
              <div className="flex justify-center mt-6">
                <div className="flex -space-x-2">
                  {[...Array(8)].map((_, i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-blue-600 border-2 border-white shadow-sm flex items-center justify-center text-white text-xs font-bold">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-md transition-transform duration-300 hover:-translate-y-1 animate-fade-in delay-600">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 text-center">Progress at your pace</h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center">
                No deadlines. No pressure. Move through levels when you&apos;re comfortable and ready.
              </p>
              <div className="flex justify-center mt-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-md transition-transform duration-300 hover:-translate-y-1 animate-fade-in delay-800">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 text-center">Safe environment</h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center">
                Supportive community where mistakes are learning opportunities, not failures.
              </p>
              <div className="flex justify-center mt-6">
                <div className="inline-flex items-center px-4 py-2 bg-green-50 border border-green-200 rounded-full">
                  ...
                  <span className="text-green-700 font-semibold text-sm">100% Safe & Supportive</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-sm hover:shadow-md transition-transform duration-300 hover:-translate-y-1 animate-fade-in delay-1000">
              ...
              <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 text-center">Tech-focused topics</h3>
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed text-center">
                Talk about what you know: APIs, architectures, frameworks, and tools you love.
              </p>
              <div className="flex justify-center mt-6 space-x-2">
                ...
                <span className="px-3 py-1 bg-gray-100 text-gray-700 rounded-full text-sm font-medium">...</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-16 sm:py-24 lg:py-40 bg-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-12 sm:mb-16 max-w-4xl mx-auto leading-relaxed animate-fade-in delay-300 px-4">
            Join {animatedStats.members}+ developers practicing live every week. Next session starts in 3 days.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center mb-12 sm:mb-16 animate-fade-in delay-500">
            ...
            >
              ...
              <svg className="w-8 h-8 mr-4 relative z-10" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="relative z-10">Join Discord - It&apos;s Free</span>
              <svg className="w-6 h-6 ml-4 group-hover:translate-x-1 transition-transform duration-300 relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8 max-w-4xl mx-auto animate-fade-in delay-700">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h4 className="text-white font-bold text-lg mb-2">Free to Join</h4>
              <p className="text-gray-300 text-sm">No hidden fees, no subscriptions. Just pure community support.</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h4 className="text-white font-bold text-lg mb-2">No Commitment</h4>
              <p className="text-gray-300 text-sm">Leave anytime. No contracts, no obligations, no pressure.</p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <h4 className="text-white font-bold text-lg mb-2">Start This Week</h4>
              <p className="text-gray-300 text-sm">Join a session this week. Your speaking journey begins immediately.</p>
            </div>
          </div>

          {/* Community Preview */}
          <div className="mt-12 sm:mt-16 animate-fade-in delay-900">
            <p className="text-gray-400 text-sm sm:text-base lg:text-lg mb-4 sm:mb-6">Trusted by developers from</p>
            <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 opacity-60">
              <div className="text-white/60 font-semibold text-sm sm:text-base">Google</div>
              <div className="text-white/60 font-semibold text-sm sm:text-base">Meta</div>
              <div className="text-white/60 font-semibold text-sm sm:text-base">Netflix</div>
              <div className="text-white/60 font-semibold text-sm sm:text-base">Stripe</div>
              <div className="text-white/60 font-semibold text-sm sm:text-base">Shopify</div>
            </div>
          </div>
        </div>
      </section>
