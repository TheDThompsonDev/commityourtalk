          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative transition-all duration-1000 delay-300 opacity-100 translate-y-0 mt-8 lg:mt-0 lg:max-w-md">
              <div className="relative bg-white/5 rounded-xl p-3 sm:p-4 shadow-xl border border-white/10">
                ...
                <div className="flex items-center gap-2 pb-2.5 border-b border-white/10 mb-2.5">
                  <div className="relative">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm shadow-lg">
                      AM
                    </div>
                    <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-green-500 rounded-full border-2 border-slate-800 flex items-center justify-center">
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  <span className="px-2 py-0.5 rounded-full text-[10px] sm:text-xs bg-white/10 text-white border border-white/20">
                    60 min
                  </span>
                  <span className="px-2 py-0.5 rounded-full text-[10px] sm:text-xs bg-white/10 text-white border border-white/20">
                    Small groups
              ...
              <div className="grid grid-cols-2 gap-1.5 mt-2.5">
                <div className="bg-white/5 rounded-lg p-2 sm:p-2.5 shadow-xl border border-white/10 group">
                  <div className="flex items-center gap-1.5 mb-1">
                    <div className="w-6 h-6 sm:w-7 sm:h-7 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-lg">
                      <svg
                ...
                <div className="bg-white/5 rounded-lg p-2 sm:p-2.5 shadow-xl border border-white/10 group">
                  <div className="flex items-center gap-1.5 mb-1">
                    <div className="w-6 h-6 sm:w-7 sm:h-7 bg-gradient-to-br from-pink-500 to-pink-600 rounded-lg flex items-center justify-center shadow-lg">
                      <svg
                        className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white"
                        fill="none"
                        viewBox="0 0 24 24"
                  ...
                  <div className="flex -space-x-0.5">
                    {[...Array(5)].map((_, i) => (
                      <div
                        key={i}
                        className="w-2 h-2 sm:w-2.5 sm:h-2.5 bg-gradient-to-br from-pink-400 to-pink-500 rounded-full border border-white animate-pulse"
