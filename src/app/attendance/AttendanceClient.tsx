...
export default function AttendanceClient({ user }: AttendanceClientProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (codeUpper.length !== 8) {
      setResult({ success: false, message: 'Attendance code must be 8 characters' });
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-16">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl sm:text-5xl font-bold text-slate-900 mb-4">Mark Your Attendance</h1>
          <p className="text-xl text-slate-600">Enter the 8-digit code shared during the live session</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 sm:p-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="code" className="block text-sm font-semibold text-slate-900 mb-3">
                Attendance Code
              </label>
              <input
                type="text"
                ...
                required
              />
              <p className="mt-2 text-sm text-slate-600">Enter the 8-character code exactly as shown</p>
            </div>
        ...
        <div className="mt-12 bg-blue-50 rounded-xl p-6 border border-blue-200">
          ...
          <div className="space-y-3">
            {[
              ...
              'The organizer will share an 8-digit attendance code during the session',
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-600 mb-4">Don’t have a code? Join our next session!</p>
          <a
