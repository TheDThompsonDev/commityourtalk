...
export default function AdminSessionsPage({ user }: AdminSessionsProps) {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-300">
                  Start sessions and manage attendance codes
                </p>
              </div>
              <Link
                href="/admin"
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border-2 border-white/20">
                  <div className="text-center mb-3">
                    ...
                    <button
                      onClick={() =>
                        copyToClipboard(activeSession.attendanceCode!)
                      }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            ...
            <p className="text-slate-600">
              Manage upcoming, active, and past sessions
            </p>
          </div>
                    ...
                    {session.status === "active" && session.attendanceCode && (
                      <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            onClick={() =>
                              copyToClipboard(session.attendanceCode!)
                            }
