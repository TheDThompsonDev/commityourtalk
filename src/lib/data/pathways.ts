...
/**
 * Collection of all learning pathways in the curriculum.
 * Pathways progress from Level 1 (Debugger's Dialogue) to Level 5 (Conference Keynote).
 */
export const pathways: readonly Pathway[] = [
  {
    ...
    description:
      "Start your journey to confident communication. Learn to structure your thoughts, find your voice, and overcome initial speaking anxiety in a safe, supportive environment.",
    focus:
      "Overcoming initial speaking anxiety, structuring thoughts, and finding your voice in a safe environment.",
    weeklyTopics: [
    ...
    experimentalChallenges: [
      {
        ...
        description:
          'One person shares a (non-project) code snippet. The others must practice giving supportive, constructive feedback, phrased as a question: "I like this. What if we tried [X]?" or "I wonder what the impact of [Y] would be?" (Teaches diplomatic communication.)',
      },
      {
        title: 'The "Two Audiences" (Simplified)',
        description:
          "Pick one topic. Minute 1: Explain it to a fellow dev. Minute 2: Explain it to a non-technical friend. (Focuses on basic audience adaptation.)",
      },
    ],
    goals: [
  ...
  },
  {
    ...
    description:
      "Develop the ability to explain complex technical concepts clearly to varied audiences. Learn to handle questions effectively and use visuals to enhance your message.",
    focus:
      "Clearly explaining complex technical concepts to varied audiences, handling questions, and using visuals effectively.",
    weeklyTopics: [
    ...
    experimentalChallenges: [
      {
        ...
        description:
          'Each person gets a prompt. Before speaking, they must state who they imagine their audience is (e.g., "I\'m explaining this to a CEO," "I\'m explaining this to a junior dev"). They then deliver their 2-3 minute explanation tailored to that persona. (Emphasizes audience adaptation.)',
      },
      {
        title: 'The "Investigative Intro" Drill',
        description:
          "For any technical topic, craft an introduction that starts with a question or a relatable problem statement that the audience might be experiencing, leading them into why your talk is important.",
      },
    ],
    goals: [
      "Deep Dive Demo",
  ...
  },
  {
    ...
    description:
      "Step into leadership through communication. Learn to influence teams, lead discussions, deliver persuasive arguments, and motivate others toward shared goals.",
    focus:
      "Influencing teams, leading discussions, delivering persuasive arguments, and motivating others.",
    weeklyTopics: [
    ...
    experimentalChallenges: [
      {
        ...
        description:
          'One person proposes a technical choice (e.g., "We should use microservices for our next project"). The rest of the group must politely challenge that idea, acting as "Devil\'s Advocates." The speaker practices defending their idea calmly and with logic.',
      },
      {
        title: "The Mediator",
        description:
          'Give the group a scenario: "Two senior devs are in a stalemate over React vs. Vue." One person must act as the team lead and mediate, only asking questions to find common ground.',
      },
    ],
    goals: [
      "The Team Update",
  ...
  },
  {
    ...
    description:
      "Craft impactful presentations for broader audiences. Learn to inspire innovation, communicate business value, and build your professional brand as a thought leader.",
    focus:
      "Crafting impactful presentations for broader audiences, inspiring innovation, and building a professional brand.",
    weeklyTopics: [
    ...
    experimentalChallenges: [
      {
        ...
        description:
          'One person presents a feature (e.g., "We\'re adding a new button to the dashboard"). The group must ask "Why?" five times until the speaker gets to the core human or business value. (Focuses on articulating deep impact.)',
      },
      {
        title: 'The "Future Headline"',
        description:
          "Describe a future where your technology (or a concept) has achieved its full potential. Imagine you're writing a news headline about it 5 years from now – what does it say, and what's the story behind it?",
      },
    ],
    goals: [
  ...
  },
  {
    ...
    description:
      "Master the art of high-stakes presentations. Learn to command large audiences, deliver powerful keynotes, and contribute meaningfully to the wider tech community.",
    focus:
      "Delivering high-stakes presentations, commanding a large audience, and contributing to the wider tech community.",
    weeklyTopics: [
    ...
    experimentalChallenges: [
      {
        ...
        description:
          'Give the group a strong, debatable topic (e.g., "AI code assistants will ultimately make developers dumber"). Assign two people "For" and two "Against." Each person gets 1 minute to make their case. (Focuses on structuring arguments under pressure.)',
      },
      {
        title: 'The "Emotional Arc"',
        description:
          'One person briefly outlines a topic for a 5-minute talk. The group then discusses and helps them plot the "emotional journey" they want the audience to experience during that talk (e.g., "Start with frustration, move to curiosity, end with empowerment").',
      },
    ],
    goals: [
...
/**
 * C.O.D.E. Feedback Framework for giving constructive feedback
 * Connect, Observe, Deepen, Explore
 */
export const codeFeedbackFramework: FeedbackFramework = {
  title: "C.O.D.E. Feedback Framework",
  description:
    "A structured approach to giving constructive feedback at all levels",
  elements: [
    {
      letter: "C",
      word: "Connect",
    ...
    },
    {
      ...
      word: "Deepen",
      prompt:
        "I'm curious about [X part of the talk]. Could you tell us more about...?",
    },
    {
      letter: "E",
      word: "Explore",
      prompt:
        "As an experiment for next time, I wonder what would happen if you...?",
    },
  ] as const,
} as const;
