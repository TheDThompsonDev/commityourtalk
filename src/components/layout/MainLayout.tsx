          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-12">
              <Link href="/" className="flex items-center gap-2">
                <div className="w-8 h-8 bg-[#3685ff] rounded-lg flex items-center justify-center">
      ...
      <footer className="bg-[#0A0911] text-white border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">Commit Your Talk</span>
              </div>
              <p className="text-gray-400 mb-6 max-w-md">
                Transform from a nervous developer into a confident speaker through live practice sessions in our supportive Discord community.
              </p>
              <a 
                href="https://discord.gg/your-invite"
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li><Link href="/pathway" className="hover:text-white transition-colors">Pathways</Link></li>
                <li><Link href="/signin" className="hover:text-white transition-colors">Dashboard</Link></li>
                <li><Link href="/profile" className="hover:text-white transition-colors">My Progress</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li><a href="https://discord.gg/your-invite" className="hover:text-white transition-colors">Discord</a></li>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">&copy; 2024 Commit Your Talk. Built for developers, by developers.</p>
